/**
 * il2cpp-export-names.ts — the canonical list of IL2CPP C API exports, in the
 * order they appear in il2cpp-api-functions.h (Unity 2022 layout, 234 entries).
 *
 * Animal Company ships a libil2cpp / GameAssembly whose export names are
 * obfuscated (random 11-char strings).  The obfuscator renames symbols but does
 * not reorder the functions, so sorting the module's exports by address and
 * zipping them with this list recovers the mapping.  See `il2cpp-exports.ts`.
 *
 * Generated from the community maps used by Comet.PC / OrbitMenu.
 */
export const CANONICAL_IL2CPP_EXPORTS: readonly string[] = [
    "il2cpp_init",
    "il2cpp_init_utf16",
    "il2cpp_shutdown",
