      ...
      <div className="glass-card rounded-2xl p-6 mb-8 space-y-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex h-10 flex-1 rounded-xl border border-white/[0.08] px-4 text-sm text-zinc-200 placeholder:text-zinc-600 transition-all duration-200 focus:border-white/[0.18] focus:outline-none"
          ...
          <select
            ...
            className="h-10 rounded-xl border border-white/[0.08] px-3 text-sm text-zinc-300 focus:outline-none focus:border-white/[0.18] transition-all"
            style={{ background: '#0A0A0C', boxShadow: 'inset 0 1px 0 0 rgba(255,255,255,0.04)' }}
          >
