    ...
    <div className="flex min-h-screen items-center justify-center px-4 pt-16">
      <div className="w-full max-w-sm animate-[fade-in_0.3s_ease-out]">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-zinc-500">Google or magic link — no password.</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          ...
          <button
            ...
            className="flex h-10 w-full items-center justify-center gap-2.5 rounded-xl border border-white/[0.1] bg-white/[0.04] text-sm font-medium text-zinc-200 transition-all duration-200 ease-out hover:bg-white/[0.08] hover:border-white/[0.14] hover:text-zinc-100 active:scale-[0.98] disabled:opacity-40"
          >
            {googleLoading ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="mono text-[10px] text-zinc-700">or</span>
            <div className="h-px flex-1 bg-zinc-800" />
          </div>
