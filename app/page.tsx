...
const modules = [
  ...
  },
  {
    href: '/proxy',
    label: 'Proxy Browser',
    desc: 'Browse any site with server-side request masking, stealth tab presets, Base64 URL encoding, and about:blank popup mode',
    tag: 'Proxy',
    icon: '🌐',
  ...
  },
  {
    href: '/games',
    label: 'Game Arcade',
    desc: '20+ unblocked HTML5 games, retro ROM emulator (NES/GBA/SNES), and classic Flash games via Ruffle',
    tag: 'Games',
    icon: '🎮',
  ...
  },
  {
    href: '/ai',
    label: 'AI Assistant',
    desc: 'Streaming AI with multi-turn chat, essay writer, humanizer, summarizer — no API key needed',
    tag: 'AI',
    icon: '🤖',
  ...
  },
  {
    ...
    desc: 'PIN-protected local note vault with XOR encryption, color-coded notes, and export',
    tag: 'Vault',
    icon: '🔒',
